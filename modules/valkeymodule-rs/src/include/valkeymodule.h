...
// Returns the response message containing the relevant information on success, NULL if no more responses.
...
// Core invokes this callback to get the next completed storage response from the external storage module.
// The response can indicate task completion for read/write/delete, flush, expiry/eviction, getting key names, etc.
// Returns VALKEYMODULE_OK on success, VALKEYMODULE_ERR if no more responses.
// typedef int (*ValkeyModuleExternalStorageResponseCallback)(struct ValkeyModuleCtx *ctx,
//                                                    int *type,
//                                                    int *db_id,
//                                                    ValkeyModuleString **key,
//                                                    long long *ttl,
...
// Module invokes this for external storage layer registration
